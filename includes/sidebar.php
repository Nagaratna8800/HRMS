                ...
                <div class="side-nav-wrapper">
                    <!-- <div class="sidebar-profile"> -->
                        <div class="sidebar-profile-image">
                            <img src="assets/images/emp.png" alt="Employee" width="150px" height="100px" hspace="30" vspace="10">
                        </div>
...
{               ?>
                                <p style="padding-left: 75px;"><?php echo htmlentities($result->FirstName." ".$result->LastName);?></p>
                                <span style="padding-left: 75px;"><?php echo htmlentities($result->EmpId)?></span>
                         <?php }} ?>
                        </div>
                    <!-- </div> -->
